...
@section('content')
    ...
    <!-- Default box -->
            ...
            <div class="box">
                <div class="box-body">
                    <h2>Customers that have ordered From {{$from_date}} To {{$to_date}}</h2>
					...
					<td>
					  ...
					  <a href="{{route('admin.reports.active-client-report')}}" class="btn btn-default mb-2">Reset</a>
					  <a href="{{route('admin.reports.export-active-client-report')}}{{ (Request::getQueryString()) ? '?'.Request::getQueryString() : '' }}" class="btn btn-primary mb-2">Export Active Customers</a>
					  </div></td>
                    </tr>
                    </table>
					</form>
					...
					<table class="table table-bordered table-striped">
						...
						<td><a href="{{ route('admin.orders.customer_order_list', $customer->id) }}" class="btn btn-xs btn-info" target="_blank" title="View Customer Orders"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
						</tr>
						@endforeach
