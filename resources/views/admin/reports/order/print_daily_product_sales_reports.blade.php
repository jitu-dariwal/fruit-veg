                    ...
                    <div class="table-responsive">
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th align="center" class="">Weight</th>
						...
						<td align="center"><a href="{{route('admin.products.show',$items->product_id)}}">{{$items->product_name}} {{(!empty($items->type)?'('.$items->type.')':'')}}</a></td>
						<td align="center">{{$items->orderProQty}}</td>
						<td align="center">{{$items->actual_weight.' '.$items->weight_unit}}</td>
