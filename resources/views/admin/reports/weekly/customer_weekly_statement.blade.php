...
@endsection
    ...
    <!-- Default box -->
            ...
            <div class="box">
                <div class="box-body">
                    <h2>Customer Statement for weekly invoices</h2>
					...
					<table class="table table-striped">
					  ...
					  <a href="{{route('admin.reports.customer-weekly-statement')}}" class="btn btn-default mb-2">Reset</a>
					  </div>
					  </td>
						</tr>
