<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  	...
  	<title>Weekly Invoice - #{{$data['invoice_id']}}</title>
  	<style>
	...
	@php
					  $invoiceId=Finder::getInvoiceId($data['week_no'],$data['year'],$data['customer']->id);
	...
	<table width="100%"  border="0" cellspacing="2" cellpadding="2" >
			...
			<td  class="heading" align="left" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; " >Contact:</td>
  			...
  			<td width="61%"  class="row2" align="left" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; "><b>{{\Carbon\Carbon::parse($data['w_start'])->format('d/m/Y')}} - {{\Carbon\Carbon::parse($data['w_end'])->format('d/m/Y')}}</b></td>
	...
	<table  width=100% border="0" >
  	<tr>
  	<td align="left" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; ">Weekly Invoice - #{{$data['invoice_id']}}</td>
  	</tr>
  	<tr>
  		<td align="left" >&nbsp;</td>
  		</tr>
