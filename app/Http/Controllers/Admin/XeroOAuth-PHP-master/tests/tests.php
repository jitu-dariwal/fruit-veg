...
if (isset($_REQUEST['invoicesmodified'])) {
   ...
   if( isset($_REQUEST['contacts'])) {
       if (!isset($_REQUEST['method'])) {
           $response = $XeroOAuth->request('GET', $XeroOAuth->url('Contacts', 'core'), array('Where' => 'Name==("Rakesh")'));
           if ($XeroOAuth->response['code'] == 200) {
  ...
  <ContactNumber>9999</ContactNumber>
  <Name>Rakesh</Name>
  <FirstName>John</FirstName>
  <LastName>Smith</LastName>
  <EmailAddress>john.smith@gmail123.com</EmailAddress>  
</Contact>
                   </Contacts>
                   ";
