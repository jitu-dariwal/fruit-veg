								...
								<div class="controlar">
									<div class="left-textbox">
										<div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
											<input type="text" name="first_name" id="first_name" placeholder="First Name" class="form-control" value="{{ old('first_name') }}" data-validation="required alphanumeric length" data-validation-length="1-255" />
										...
										<div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
											<input type="text" name="last_name" id="last_name" placeholder="Last Name" class="form-control" value="{{ old('last_name') }}" data-validation="alphanumeric length" data-validation-length="1-255" data-validation-optional="true"/>
										...
										<div class="form-group{{ $errors->has('company_name') ? ' has-error' : '' }}">
											<input type="text" name="company_name" id="company_name" placeholder="Company Name" class="form-control" value="{{ old('company_name') }}" data-validation="required length" data-validation-length="1-255" />
										...
										<div id="custom-search-input3">
											<div class="input-group{{ $errors->has('post_code') ? ' has-error' : '' }}">
												...
												<input class="search-query form-control" id="post_code" name="post_code" value="{{ old('post_code') }}" placeholder="Enter postcode" data-validation="required length" data-validation-length="1-191">
										...
										<div class="form-group{{ $errors->has('street_address') ? ' has-error' : '' }}">
											<textarea name="street_address" id="street_address" placeholder="First line of address" class="form-control c-textarea" data-validation="required length" data-validation-length="1-255">{{ old('street_address') }}</textarea>
										...
										<div class="form-group">
											<textarea name="address_line_2" id="address_line_2" placeholder="Second line of address" class="form-control c-textarea" data-validation="length" data-validation-length="0-255" data-validation-optional="true">{{ old('address_line_2') }}</textarea>
										</div>
										
										<div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
											<input type="text" name="city" id="city" placeholder="Town" class="form-control" value="{{ old('city') }}" data-validation="required length" data-validation-length="1-191">
											@if ($errors->has('city'))
												<span class="help-block text-danger">
										...
										<div class="form-group{{ $errors->has('county_state') ? ' has-error' : '' }}">
											<input type="text" name="county_state" id="county_state" placeholder="County" class="form-control" value="{{ old('county_state') }}" data-validation="required">
									...
									<div class="right-btn">
										<button type="submit" class="btn btn-greem">Save</button>
									</div>
								</div>
							</form>
						</div>
