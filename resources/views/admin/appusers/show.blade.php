        ...
        <div class="box">
            <div class="box-body">
                ...
                <table class="table">
                    <tbody>
                    <tr>
                        <td class="col-md-4"><strong>Company Name</strong></td><td>{{ $customer->company_name }}</td>
                    </tr>
					<tr>
					...
					<tr>
                       <td class="col-md-4"><strong>Post Code</strong></td><td>{{ $customer->post_code }}</td>
                    </tr>
					<tr>
                       <td class="col-md-4"><strong>City</strong></td><td>{{ $customer->city }}</td>
                    </tr>
					<tr>
                       <td class="col-md-4"><strong>County/State</strong></td><td>{{ $customer->county_state }}</td>
                    </tr>
					<tr>
                       <td class="col-md-4"><strong>Country</strong></td><td>{{ $customer->country }}</td>
                    </tr>
					<tr>
